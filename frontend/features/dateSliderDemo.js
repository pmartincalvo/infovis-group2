...
(function($, undefined){
	...
	$.widget("ui.dateSliderDemo", $.ui.sliderDemo, {
		...
		_createBoundsOptions: function(){
			...
			this._addDateOption(maxSelect, new Date(2017, 11, 31, 11, 59, 59));
			this._addDateOption(maxSelect, new Date(2017, 8, 31, 11, 59, 59));
			this._addDateOption(maxSelect, new Date(2017, 5, 30, 11, 59, 59));
		...
		_minSelectChange: function(e){
			...
			this._setRangeOption($.parseJSON('{"days": 28}'), "min");
		},

		_maxSelectChange: function(e){
			var value = $(e.target).val();
			this._setRangeOption($.parseJSON({"days": 365}), "max");
		},
